...
> 下一步：M7（性能与安全检查）/ M8（交付报告）。M6 的 B1/B2 数据缺口已于 2026-09-15 补齐（Overpass 经 `maps.mail.ru` 镜像可用）。
...
| M6 | ~~补齐 B1/B2 数据缺口~~、关系图扩量、知识库扩至全类别达标 | B1/B2 **✅（2026-09-15）**；关系图扩量仍 ⏳（仍 800 地点 / 5445 对，OSRM 真实路网 163 对约 3%） |
